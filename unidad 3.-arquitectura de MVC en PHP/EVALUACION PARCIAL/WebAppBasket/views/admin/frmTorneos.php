...
<div class="text-end text-muted mb-2">
    <small>Alumno: Jonathan García</small>
</div>
        ...
        <form action="torneosInsert.php" method="post">
            ...
            <div class="row">
                <div class="col mb-3">
                    ...
                    <input type="text" name="txtSede" id="sede" class="form-control" required>
                </div>

                <div class="col mb-3">
                    <label for="categoria" class="form-label">CATEGORIA</label>
                    <input list="lstCategorias" name="txtCategoria" id="categoria" class="form-control" required>
            ...
            <div class="row">
                ...
                <div class="col mb-3">
                    ...
                    <input type="password" name="txtContrasena" id="contrasena" class="form-control" required>
                </div>
            </div>
